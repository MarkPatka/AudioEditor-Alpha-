...
namespace AudioEditor.Logics
{
    ...
    public class CustomWaveViewer : System.Windows.Forms.UserControl
    {
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            else if (e.Button == MouseButtons.Right) FitToScreen();
        ...
        {
            ControlPaint.DrawReversibleLine(PointToScreen(new Point(x, 0)), PointToScreen(new Point(x, Height)), Color.Aquamarine);
